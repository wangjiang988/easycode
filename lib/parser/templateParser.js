...
class Template {
  ...
  doParseNoteLine(line) {
    ...
    // 字段描述，java语言解析表结构
            ...
            && (typeof this.globalVaris.group != 'undefined')) {
      // value 其实是表名
    ...
    // 生成路径
      ...
      this.targetPath = path.join(this.projectRootPath, this.targetPath.replace('@projectRoot', '.'));
...
class TemplateParser {
  // 解析出模板对象
  static parse(filePath, easycode, callback) {
